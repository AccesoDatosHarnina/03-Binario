...
public class Cliente implements Serializable{
	...
	/*
	 * Según java no puedes sobreescribir equals y dejar hashcode igual
	 * El contrato te obliga a cambiar hashcode si cambias equals porque 
	 * si son iguales por equals son iguales por hashcode pero no al reves
	 * es decir si son iguales por hashcode no tienen porque ser iguales segun equals
	 */
	@Override
	public int hashCode() {
		//para cumplir con lo anterior estamos obligados a crear un valor hash que dependa de los
		//atributos que usamos para comparar
		//1º usa un valor primo para la constante hash
		int hash=13;
		//2º genera la clave hash usando el valor anterior y algún factor numérico de los campos
		//que tratamos podemos complicarlo un poco tanto como queramos dentro de las leyes
